...
- (void)drawSubAtPoint:(NSPoint)point
{
	if (!_img)
	{
		return;
...
- (void)drawCocoaSubAtPoint:(NSPoint)point
{
	[_img drawAtPoint:point fromRect:CGRectZero operation:NSCompositeSourceOver fraction:1.0];
}
