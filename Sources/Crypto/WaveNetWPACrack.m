...
void fastF(unsigned char *password, NSInteger pwdLen, const unsigned char *ssid, NSInteger ssidlength, const mbedtls_sha1_context *ipadContext, const mbedtls_sha1_context *opadContext, NSInteger count, unsigned char output[40])
{
